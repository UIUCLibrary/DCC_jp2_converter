...
from dcc_jp2_converter import exic2CommandBuilders, Exiv2CommandBuilder
...
def test_insert_command_builder(monkeypatch):
    ...
    command_builder = Exiv2CommandBuilder(builder=exic2CommandBuilders.InsertIPTCCommand(),
                                                      program_path=DUMMY_EXIV2_PATH)
    command = command_builder.build_command(src=src_file)
