        ...
        stage("Update online documentation") {
            ...
            steps {
                ...
                script {
                    ...
                    sh("scp -ir /var/lib/jenkins/secrets/lib-dccdocs-updater docs/build/html/ lib-dccdocs-updater@apache-ns.library.illinois.edu:/www/dccdocs/dcc_jp2_converter/")
