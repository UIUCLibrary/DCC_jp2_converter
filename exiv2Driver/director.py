...
from exiv2Driver.config import get_exiv2_path
import os
...
class Director:
    ...
    def build_command(self, src: str, arg: str = None) -> list:
        ...
        Examples:
            ...
            >>> command_builder = Director(builder=commandBuilders.ExtractIPTCCommand())
            ...
            >>> command_builder = Director(builder=commandBuilders.CopyIPTCCommand())
